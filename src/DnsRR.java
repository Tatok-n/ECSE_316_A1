...
public class DnsRR {
    ...
    public DnsRR(List<DnsLabel> name, DnsQueryType type, int classParam, long ttl, int rdLength, RData rData) {
        this.NAME = name;
        this.TYPE = type;
    ...
    public String toString(boolean auth) {
        ...
        // Handle cases for IP addresses
            ...
            sb.append(DnsQueryType.toString(TYPE)).append("\t").append(rData.getRdata()).append("\t").append(TTL).append("\t").append(authFlag);
        } else {
            sb.append(DnsQueryType.toString(TYPE)).append("\t").append(domainName).append("\t").append(TTL).append("\t").append(authFlag);
        }
